...
```bash
git clone https://github.com/alvinhtml/git-test.git
```
...
将暂存区的代码提交到仓库，并生成一个新的 commit ID
...
## reset
前面章节已经说道Git有三个区域，Git 的所有操作实际上是在操作这三个区域的状态（或内容）。
...
```bash
git cherry-pick c9be483b82e0723a15c8c62a4b8cbcc9a318e119..fcfcc929b5a8bb87a7608af81dbe20388f06bb4b
```
